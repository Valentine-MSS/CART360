...
void live()
{
  ...
  //  if (note > 10) {
  //    tone (BUZZER_PIN, note + offsetFrequency, duration);
  //  }
  ...
  // output sound
  //
  if (note >= 1010 && note <= 1035) {
    tone(BUZZER_PIN, 550 + offsetFrequency, duration);
    delay(10);
  }
  else if (note >= 920 && note <= 940) {
    tone(BUZZER_PIN, 440 + offsetFrequency, duration);
    delay(10);
  }
  else if (note >= 475 && note <= 495) {
    tone(BUZZER_PIN, 550 + offsetFrequency, duration);
    delay(10);
  }
  else if (note >= 455  && note <= 470) {
    tone(BUZZER_PIN, 660 + offsetFrequency, duration);
    delay(10);
  }

  else if (note >= 300  && note <= 325) {
    tone(BUZZER_PIN, 880 + offsetFrequency, duration);
    delay(10);
...
void playCurrentNote()
{
  ...
  //Serial.println(note);
  tone (BUZZER_PIN, peakValue + offsetFrequency, duration);
  // output sound
  //
  //  if (testNote >= 1010 && testNote <= 1035) {
  //    tone(BUZZER_PIN, peakValue + offsetFrequency, duration);
  //    delay(100);
  //
  //  }
  //  else if (testNote >= 920 && testNote <= 940) {
  //    tone(BUZZER_PIN, peakValue + offsetFrequency, duration);
  //    delay(100);
  //
  //  }
  //  else if (testNote >= 475 && testNote <= 495) {
  //    tone(BUZZER_PIN, peakValue + offsetFrequency, duration);
  //    delay(100);
  //
  //  }
  //  else if (testNote >= 455  && testNote <= 470) {
  //    tone(BUZZER_PIN, peakValue + offsetFrequency, duration);
  //    delay(100);
  //  }
  //
  //  else if (testNote >= 300  && testNote <= 325) {
  //    tone(BUZZER_PIN, peakValue + offsetFrequency, duration);
  //    delay(100);
  //
  //  }
...
{
  int photocellav = analogRead(PHOTO_PIN);
  runningAverageBuffer[RUNNING_SAMPLES] = photocellav;
  nextCount++;
...
void playWithDuration()
{
  ...
  for (int i = 0; i < countNotes; i++) {
   ...
   // Serial.println(countNotes);
    ...
    delay(durations[i] + 110); // wait for tone to finish
    //check if mode button is pressed
